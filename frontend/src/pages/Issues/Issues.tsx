...
export default function Issues() {
  const { selectedProjectId, currentProject, fetchProject } = useProjectStore();
      ...
      if (selectedProjectId) {
        ...
        try {
          const url = selectedCrawlId
            ? `/issues/${selectedProjectId}/summary?crawlId=${selectedCrawlId}`
            : `/issues/${selectedProjectId}/summary`;
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                          {issue.count} {issue.count === 1 ? "URL" : "URLs"}{" "}
                          affected
                        </p>
                      </div>
                      <Link
                        to={`/issues/view?type=${issue.issueTypeId}`}
