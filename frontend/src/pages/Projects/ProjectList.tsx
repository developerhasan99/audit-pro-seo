      ...
      {loading && projects.length === 0 ? (
        ...
        <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
          ...
          <p className="text-slate-500 font-bold mb-8 max-w-sm mx-auto">
            Ready to start your first SEO audit? Add a website to begin tracking
            its performance.
          </p>
          <Link
            to="/projects/add"
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-6">
                    <div className="flex items-center space-x-2 px-3 py-2 bg-slate-50 rounded-xl">
                      <Shield
                        className={`w-3.5 h-3.5 ${project.ignoreRobotstxt ? "text-indigo-500" : "text-slate-300"}`}
                      />
                    ...
                    <div className="flex items-center space-x-2 px-3 py-2 bg-slate-50 rounded-xl">
                      <Network
                        className={`w-3.5 h-3.5 ${project.crawlSitemap ? "text-indigo-500" : "text-slate-300"}`}
                      />
                      <span className="text-[10px] font-black text-slate-500 uppercase tracking-wider">
                        Sitemap
                      </span>
