...
export default function PriorityActionPlan({
  issues,
}: PriorityActionPlanProps) {
      ...
      <div className="flex-1">
        {sortedIssues.map((issue, index) => {
          ...
          return (
            <div
              key={index}
              className="p-5 border-b border-slate-50 hover:bg-slate-50 transition-colors last:border-0 group cursor-default"
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex items-center space-x-3">
                    <span
                      className={`px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-tighter border ${impact.color}`}
                    >
                      {impact.label}
                    </span>
